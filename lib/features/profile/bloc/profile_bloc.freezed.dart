...
class _$FetchProfileImpl implements _FetchProfile {
  const _$FetchProfileImpl(this.userId);
  ...
  @override
  String toString() {
    return 'ProfileEvent.fetchProfile(userId: $userId)';
  }
...
abstract class _FetchProfile implements ProfileEvent {
  const factory _FetchProfile(final String userId) = _$FetchProfileImpl;
...
mixin _$ProfileState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserModel profile) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserModel profile)? success,
...
abstract class _Success implements ProfileState {
  const factory _Success(final UserModel profile) = _$SuccessImpl;
